...
function from3(value, decimals = 0) {
  if (!Number.isInteger(decimals) || decimals < 0)
    throw new InvalidDecimalsError({ decimals });
...
function fromEther(ether, unit = "wei") {
  return from3(ether, exponents.ether - exponents[unit]);
}
function fromGwei(gwei, unit = "wei") {
  return from3(gwei, exponents.gwei - exponents[unit]);
}
...
var FeePayerNonceMismatchError = class extends BaseError3 {
...
var TransactionExecutionError = class extends BaseError3 {
  constructor(cause, { account, docsPath: docsPath6, chain, data, gas, gasPrice, maxFeePerGas, maxPriorityFeePerGas, nonce, to, value }) {
    ...
    const prettyArgs = prettyPrint2({
      ...
      to,
      value: typeof value !== "undefined" && `${formatEther2(value)} ${((_a = chain == null ? void 0 : chain.nativeCurrency) == null ? void 0 : _a.symbol) || "ETH"}`,
      data,
      gas,
...
async function call(client, args) {
  ...
  try {
    ...
    const { offchainLookup: offchainLookup2, offchainLookupSignature: offchainLookupSignature2 } = await import("./ccip-WT2H2BAH.js");
...
//# sourceMappingURL=chunk-ZLQC3NOX.js.map
