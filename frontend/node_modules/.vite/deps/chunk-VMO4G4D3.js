...
// node_modules/@metamask/utils/node_modules/semver/functions/truncate.js
var require_truncate = __commonJS({
  "node_modules/@metamask/utils/node_modules/semver/functions/truncate.js"(exports, module) {
    "use strict";
    var parse = require_parse();
  ...
  return createConnector((config) => ({
    ...
    async getProvider() {
      if (!walletProvider) {
        ...
        const { createBaseAccountSDK } = await import("./dist-6FOMFDN7.js");
  ...
  return createConnector((config) => ({
    ...
    async getProvider() {
      if (!walletProvider) {
        ...
        const { createCoinbaseWalletSDK } = await import("./dist-FQJJW43D.js");
    ...
    async getProvider() {
      ...
      if (!walletProvider) {
        const CoinbaseWalletSDK = await (async () => {
          const { default: SDK } = await import("./dist-3PFAZQTK.js");
...
// node_modules/@metamask/superstruct/dist/structs/sensitive.mjs
var SENSITIVE_REDACTED = "***";
var SENSITIVE_BRAND = Symbol.for("superstruct.sensitive");
...
function withSensitiveEntries(base2, schema) {
  const sensitiveKeys = Object.keys(schema).filter(
    ...
    (key) => schema[key] !== void 0 && isSensitiveStruct(schema[key])
  );
  ...
  return new Struct({
    ...
    *entries(value, context) {
      ...
      for (const entry of base2.entries(value, context)) {
        const [fieldKey, fieldValue, fieldStruct] = entry;
        yield [
          fieldKey,
          fieldValue,
...
function object(schema) {
  ...
  return withSensitiveEntries(base2, schema);
}
    ...
    async getProvider() {
      async function initProvider() {
        ...
        const MetaMaskSDK = await (async () => {
          const { default: SDK } = await import("./metamask-sdk-57IOCXXT.js");
          if (typeof SDK !== "function" && typeof SDK.default === "function")
            return SDK.default;
          return SDK;
        })();
    ...
    return {
      ...
      async getPortoInstance() {
        porto_promise ?? (porto_promise = (async () => {
          const { Porto } = await import("./dist-2X5TWBUK.js");
          return Porto.create({
            ...parameters,
  ...
  return createConnector((config) => ({
    ...
    async getProvider() {
      ...
      if (!isIframe)
        return;
      if (!provider_) {
        const { default: SDK } = await import("./esm-Q352HRKU.js");
        ...
        const SafeAppProvider = await (async () => {
          const Provider = await import("./dist-ZYCKJI3X.js");
    ...
    async getProvider({ chainId } = {}) {
      ...
      async function initProvider() {
        ...
        if (!optionalChains.length)
          return;
        const { EthereumProvider } = await import("./index.es-UGTZDPVS.js");
...
lodash/lodash.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-VMO4G4D3.js.map
