...
async function recoverPublicKey({ hash: hash2, signature }) {
  ...
  const { secp256k1: secp256k12 } = await import("./secp256k1-XANCUXWJ.js");
  const signature_ = (() => {
...
async function getBlock(client, { blockHash, blockNumber, blockTag = client.experimental_blockTag ?? "latest", includeTransactions: includeTransactions_ } = {}) {
  ...
  const format7 = ((_c = (_b = (_a = client.chain) == null ? void 0 : _a.formatters) == null ? void 0 : _b.block) == null ? void 0 : _c.format) || formatBlock;
  return format7(block, "getBlock");
}
...
async function fillTransaction(client, parameters) {
  ...
  const format7 = chainFormat || formatTransactionRequest;
  const request = format7({
  ...
  try {
    ...
    const format8 = ((_d = (_c = chain == null ? void 0 : chain.formatters) == null ? void 0 : _c.transaction) == null ? void 0 : _d.format) || formatTransaction;
    const transaction = format8(response.tx);
...
async function getBlockReceipts(client, { blockHash, blockNumber, blockTag = client.experimental_blockTag ?? "latest" } = {}) {
  ...
  if (!receipts)
    throw new BlockNotFoundError({ blockHash, blockNumber });
  const format7 = ((_c = (_b = (_a = client.chain) == null ? void 0 : _a.formatters) == null ? void 0 : _b.transactionReceipt) == null ? void 0 : _c.format) || formatTransactionReceipt;
  return receipts.map((receipt) => format7(receipt, "getBlockReceipts"));
}
...
function hmac256(key, value, options = {}) {
  const { as = typeof value === "string" ? "Hex" : "Bytes" } = options;
  const bytes = hmac(sha2562, from2(key), from2(value));
  if (as === "Bytes")
    return bytes;
  return fromBytes(bytes);
}
...
__export(Signature_exports, {
  ...
  InvalidYParityError: () => InvalidYParityError2,
...
function fromDerHex(signature) {
  const { r, s } = secp256k1.Signature.fromDER(from3(signature).slice(2));
  return { r, s };
}
...
function verify(options) {
  ...
  return secp256k1.verify(options.signature, from2(payload), toBytes2(options.publicKey), ...hash2 ? [{ prehash: true, lowS: true }] : []);
}
...
async function getTransaction(client, { blockHash, blockNumber, blockTag: blockTag_, hash: hash2, index: index2, sender, nonce }) {
  ...
  const format7 = ((_c = (_b = (_a = client.chain) == null ? void 0 : _a.formatters) == null ? void 0 : _b.transaction) == null ? void 0 : _c.format) || formatTransaction;
  return format7(transaction, "getTransaction");
}
...
async function getTransactionReceipt(client, { hash: hash2 }) {
  ...
  const format7 = ((_c = (_b = (_a = client.chain) == null ? void 0 : _a.formatters) == null ? void 0 : _b.transactionReceipt) == null ? void 0 : _c.format) || formatTransactionReceipt;
  return format7(receipt, "getTransactionReceipt");
}
...
function decode3(...parameters) {
  const [abiEvent, log] = (() => {
    if (Array.isArray(parameters[0])) {
      const [abi2, name, log2] = parameters;
      return [fromAbi3(abi2, name), log2];
    }
    return parameters;
  })();
  ...
  if (nonIndexedInputs.length > 0) {
    if (data && data !== "0x") {
      try {
        ...
        if (err instanceof DataSizeTooSmallError || err instanceof PositionOutOfBoundsError2)
...
function encode5(...parameters) {
  const [abiEvent, args] = (() => {
    if (Array.isArray(parameters[0])) {
      ...
      return [fromAbi3(abi2, name), args3];
    }
...
function format5(abiEvent) {
  return formatAbiItem2(abiEvent);
}
...
var InputNotFoundError = class extends BaseError2 {
  constructor({ abiEvent, name }) {
    super(`Parameter "${name}" not found on \`${format5(abiEvent)}\`.`);
    Object.defineProperty(this, "name", {
      enumerable: true,
      configurable: true,
      writable: true,
...
var DataMismatchError = class extends BaseError2 {
  constructor({ abiEvent, data, parameters, size: size5 }) {
    super([
      ...
      metaMessages: [
        `Non-indexed Parameters: (${format2(parameters)})`,
        `Data:   ${data} (${size5} bytes)`
      ]
    });
    Object.defineProperty(this, "name", {
...
var TopicsMismatchError = class extends BaseError2 {
  constructor({ abiEvent, param }) {
    super([
      `Expected a topic for indexed event parameter${param.name ? ` "${param.name}"` : ""} for "${format5(abiEvent)}".`
    ].join("\n"));
    Object.defineProperty(this, "name", {
      enumerable: true,
      configurable: true,
...
var SelectorTopicMismatchError = class extends BaseError2 {
  constructor({ abiEvent, actual, expected }) {
    super(`topics[0]="${actual}" does not match the expected topics[0]="${expected}".`, {
      metaMessages: [`Event: ${format5(abiEvent)}`, `Selector: ${expected}`]
    });
    Object.defineProperty(this, "name", {
      enumerable: true,
      configurable: true,
...
function decodeData(...parameters) {
  ...
  const [abiFunction, data] = (() => {
    if (Array.isArray(parameters[0])) {
      ...
      return [fromAbi4(abi2, name), data2];
    }
    return parameters;
  })();
  ...
  if (((_a = abiFunction.inputs) == null ? void 0 : _a.length) === 0)
    return void 0;
  const item = overloads ? fromAbi4([abiFunction, ...overloads], data) : abiFunction;
  if (size3(data) <= 4)
    return void 0;
...
function decodeResult(...parameters) {
  const [abiFunction, data, options = {}] = (() => {
    if (Array.isArray(parameters[0])) {
      ...
      return [fromAbi4(abi2, name), data2, options2];
    }
    return parameters;
  })();
...
function encodeData2(...parameters) {
  const [abiFunction, args = []] = (() => {
    if (Array.isArray(parameters[0])) {
      const [abi2, name, args3] = parameters;
      return [fromAbi4(abi2, name, { args: args3 }), args3];
    }
    const [abiFunction2, args2] = parameters;
    return [abiFunction2, args2];
  })();
  const { overloads } = abiFunction;
  const item = overloads ? fromAbi4([abiFunction, ...overloads], abiFunction.name, {
    args
  }) : abiFunction;
...
function encodeResult(...parameters) {
  const [abiFunction, output, options = {}] = (() => {
    if (Array.isArray(parameters[0])) {
      ...
      return [fromAbi4(abi2, name), output2, options2];
    }
    return parameters;
  })();
...
async function simulateCalls(client, parameters) {
  ...
  const getBalanceData = account ? encode4(from12("constructor(bytes, bytes)"), {
  ...
  const assetAddresses = discovery ? [
    .../* @__PURE__ */ new Set([
      ...
      ...parameters.calls.map((call2) => {
        var _a;
        return (_a = call2.to) == null ? void 0 : _a.toLowerCase();
      })
    ])
  ...
  const decimals = ((block_decimals == null ? void 0 : block_decimals.calls) ?? []).map((call2) => decodeAssetResult(call2, decimalsFunction));
  const symbols = ((block_symbols == null ? void 0 : block_symbols.calls) ?? []).map((call2) => decodeAssetResult(call2, symbolFunction));
  const tokenURI = ((block_tokenURI == null ? void 0 : block_tokenURI.calls) ?? []).map((call2) => decodeAssetResult(call2, tokenUriFunction));
  const changes = [];
...
function unwrap2(wrapped) {
  assert5(wrapped);
  const [to2, data, signature] = decode(from6("address, bytes, bytes"), wrapped);
  return { data, signature, to: to2 };
}
function wrap2(value) {
  const { data, signature, to: to2 } = value;
  return concat2(encode3(from6("address, bytes, bytes"), [
    to2,
    data,
    signature
  ]), magicBytes2);
...
async function sendRawTransactionSync(client, { serializedTransaction, throwOnReceiptRevert, timeout }) {
  ...
  const format7 = ((_c = (_b = (_a = client.chain) == null ? void 0 : _a.formatters) == null ? void 0 : _b.transactionReceipt) == null ? void 0 : _c.format) || formatTransactionReceipt;
  const formatted = format7(receipt);
...
function getCall2(client, parameters) {
  const { amount, from: from16, to: to2, token } = parameters;
  const { address, decimals } = resolveToken(client, { token });
...
async function sendUnsignedTransaction(client, args) {
  var _a, _b, _c;
  const { accessList, data, from: from16, gas, gasPrice, maxFeePerGas, maxPriorityFeePerGas, nonce, to: to2, value, ...rest } = args;
  const chainFormat = (_c = (_b = (_a = client.chain) == null ? void 0 : _a.formatters) == null ? void 0 : _b.transactionRequest) == null ? void 0 : _c.format;
  const format7 = chainFormat || formatTransactionRequest;
  const request = format7({
    // Pick out extra data that might exist on the chain's transaction request type.
...
async function signTransaction(client, parameters) {
  ...
  const format7 = ((_b = formatters == null ? void 0 : formatters.transactionRequest) == null ? void 0 : _b.format) || formatTransactionRequest;
...
//# sourceMappingURL=chunk-VXJT7LCM.js.map
