...
var ICONS = {
  add: async () => (await import("./add-UKA32WHQ.js")).addSvg,
  allWallets: async () => (await import("./all-wallets-JREVXINR.js")).allWalletsSvg,
  arrowBottomCircle: async () => (await import("./arrow-bottom-circle-WDLWAW2I.js")).arrowBottomCircleSvg,
  appStore: async () => (await import("./app-store-CVQNI4IC.js")).appStoreSvg,
  apple: async () => (await import("./apple-QQ7PILLX.js")).appleSvg,
  arrowBottom: async () => (await import("./arrow-bottom-OWPVNPJT.js")).arrowBottomSvg,
  arrowLeft: async () => (await import("./arrow-left-ZEEP66NB.js")).arrowLeftSvg,
  arrowRight: async () => (await import("./arrow-right-3SNZWH7Z.js")).arrowRightSvg,
  arrowTop: async () => (await import("./arrow-top-NNFMRBMT.js")).arrowTopSvg,
  bank: async () => (await import("./bank-EDUXXPI7.js")).bankSvg,
  browser: async () => (await import("./browser-2B7DN7CU.js")).browserSvg,
  card: async () => (await import("./card-TWJFJ432.js")).cardSvg,
  checkmark: async () => (await import("./checkmark-GJ2EVYBC.js")).checkmarkSvg,
  checkmarkBold: async () => (await import("./checkmark-bold-H2F6WZOW.js")).checkmarkBoldSvg,
  chevronBottom: async () => (await import("./chevron-bottom-PUJZVVJ6.js")).chevronBottomSvg,
  chevronLeft: async () => (await import("./chevron-left-R7YC3ICX.js")).chevronLeftSvg,
  chevronRight: async () => (await import("./chevron-right-J2NC34X2.js")).chevronRightSvg,
  chevronTop: async () => (await import("./chevron-top-MNH3MOJG.js")).chevronTopSvg,
  chromeStore: async () => (await import("./chrome-store-I2DRVID4.js")).chromeStoreSvg,
  clock: async () => (await import("./clock-NSOG2ASK.js")).clockSvg,
  close: async () => (await import("./close-IJ7A67QR.js")).closeSvg,
  compass: async () => (await import("./compass-YK63JEAI.js")).compassSvg,
  coinPlaceholder: async () => (await import("./coinPlaceholder-PKJWPWHD.js")).coinPlaceholderSvg,
  copy: async () => (await import("./copy-N5I2NIUM.js")).copySvg,
  cursor: async () => (await import("./cursor-32P5PXNA.js")).cursorSvg,
  cursorTransparent: async () => (await import("./cursor-transparent-EMSBLKKP.js")).cursorTransparentSvg,
  desktop: async () => (await import("./desktop-7526BIW5.js")).desktopSvg,
  disconnect: async () => (await import("./disconnect-CHQJGHK2.js")).disconnectSvg,
  discord: async () => (await import("./discord-4DMYTQGZ.js")).discordSvg,
  etherscan: async () => (await import("./etherscan-TX4SYSWE.js")).etherscanSvg,
  extension: async () => (await import("./extension-CCZRERMM.js")).extensionSvg,
  externalLink: async () => (await import("./external-link-LWRVDUMQ.js")).externalLinkSvg,
  facebook: async () => (await import("./facebook-2DTPEYVO.js")).facebookSvg,
  farcaster: async () => (await import("./farcaster-2425OKAX.js")).farcasterSvg,
  filters: async () => (await import("./filters-YSAYFZ7P.js")).filtersSvg,
  github: async () => (await import("./github-DCWDEGIO.js")).githubSvg,
  google: async () => (await import("./google-TSGELTMY.js")).googleSvg,
  helpCircle: async () => (await import("./help-circle-IGG3RRRN.js")).helpCircleSvg,
  image: async () => (await import("./image-QN4QN75V.js")).imageSvg,
  id: async () => (await import("./id-BTYPBOBI.js")).idSvg,
  infoCircle: async () => (await import("./info-circle-M4VUBX33.js")).infoCircleSvg,
  lightbulb: async () => (await import("./lightbulb-XBPMUME7.js")).lightbulbSvg,
  mail: async () => (await import("./mail-F4XTLJVL.js")).mailSvg,
  mobile: async () => (await import("./mobile-VIKR3CDO.js")).mobileSvg,
  more: async () => (await import("./more-QCJUJ4WJ.js")).moreSvg,
  networkPlaceholder: async () => (await import("./network-placeholder-YOSM56I2.js")).networkPlaceholderSvg,
  nftPlaceholder: async () => (await import("./nftPlaceholder-VW75T7SZ.js")).nftPlaceholderSvg,
  off: async () => (await import("./off-SCDEN6KB.js")).offSvg,
  playStore: async () => (await import("./play-store-HRO36UL7.js")).playStoreSvg,
  plus: async () => (await import("./plus-RSNEXNXK.js")).plusSvg,
  qrCode: async () => (await import("./qr-code-ATK673U4.js")).qrCodeIcon,
  recycleHorizontal: async () => (await import("./recycle-horizontal-QJJ5GJD7.js")).recycleHorizontalSvg,
  refresh: async () => (await import("./refresh-I6S7O775.js")).refreshSvg,
  search: async () => (await import("./search-767BTU3K.js")).searchSvg,
  send: async () => (await import("./send-2IBTP67M.js")).sendSvg,
  swapHorizontal: async () => (await import("./swapHorizontal-DATRMVNW.js")).swapHorizontalSvg,
  swapHorizontalMedium: async () => (await import("./swapHorizontalMedium-LAEI4IQU.js")).swapHorizontalMediumSvg,
  swapHorizontalBold: async () => (await import("./swapHorizontalBold-UXHRC6F2.js")).swapHorizontalBoldSvg,
  swapHorizontalRoundedBold: async () => (await import("./swapHorizontalRoundedBold-XES6XIFZ.js")).swapHorizontalRoundedBoldSvg,
  swapVertical: async () => (await import("./swapVertical-HDTFJ3IY.js")).swapVerticalSvg,
  telegram: async () => (await import("./telegram-FQQHIQIO.js")).telegramSvg,
  threeDots: async () => (await import("./three-dots-3MMJYOUP.js")).threeDotsSvg,
  twitch: async () => (await import("./twitch-4JI6VZKN.js")).twitchSvg,
  twitter: async () => (await import("./x-UU4MOKJH.js")).xSvg,
  twitterIcon: async () => (await import("./twitterIcon-B2NCKEMY.js")).twitterIconSvg,
  verify: async () => (await import("./verify-OK4YI242.js")).verifySvg,
  verifyFilled: async () => (await import("./verify-filled-H26XVUYE.js")).verifyFilledSvg,
  wallet: async () => (await import("./wallet-MMNS53IY.js")).walletSvg,
  walletConnect: async () => (await import("./walletconnect-IXFBZLYG.js")).walletConnectSvg,
  walletConnectLightBrown: async () => (await import("./walletconnect-IXFBZLYG.js")).walletConnectLightBrownSvg,
  walletConnectBrown: async () => (await import("./walletconnect-IXFBZLYG.js")).walletConnectBrownSvg,
  walletPlaceholder: async () => (await import("./wallet-placeholder-MRNLLPNF.js")).walletPlaceholderSvg,
  warningCircle: async () => (await import("./warning-circle-SCTBNX4U.js")).warningCircleSvg,
  x: async () => (await import("./x-UU4MOKJH.js")).xSvg,
  info: async () => (await import("./info-MZE63LLP.js")).infoSvg,
  exclamationTriangle: async () => (await import("./exclamation-triangle-IUGR7IYU.js")).exclamationTriangleSvg,
  reown: async () => (await import("./reown-logo-J6LV75TR.js")).reownSvg
};
...
lit-html/development/directive-helpers.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-KLF6354D.js.map
